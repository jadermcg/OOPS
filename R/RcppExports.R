...
oops <- function(fasta, alpha, beta, cutoff, niter, w = 1) {
    .Call('_OOPS_oops', PACKAGE = 'OOPS', fasta, alpha, beta, cutoff, niter, w)
}
...
#'@param w Priori probability for motif belongs to position w1, w2, w3, ..., wm.
#'@param beta Markov model thats represents the control senquences.
logoops <- function(fasta, alpha, beta, cutoff, niter, w = 1) {
    .Call('_OOPS_logoops', PACKAGE = 'OOPS', fasta, alpha, beta, cutoff, niter, w)
}
...
Q <- function(fasta, alpha, beta) {
    .Call('_OOPS_Q', PACKAGE = 'OOPS', fasta, alpha, beta)
}
...
LL <- function(fasta, alpha, beta) {
    .Call('_OOPS_LL', PACKAGE = 'OOPS', fasta, alpha, beta)
}
...
createMarkovChain <- function(fasta, tau = 0L) {
    .Call('_OOPS_createMarkovChain', PACKAGE = 'OOPS', fasta, tau)
}
...
probSeqGivenAlpha <- function(kmer, alpha) {
    .Call('_OOPS_probSeqGivenAlpha', PACKAGE = 'OOPS', kmer, alpha)
}
...
probSeqGivenAlphaLog <- function(kmer, alpha) {
    .Call('_OOPS_probSeqGivenAlphaLog', PACKAGE = 'OOPS', kmer, alpha)
}
...
probSeqGivenBeta <- function(seq, beta) {
    .Call('_OOPS_probSeqGivenBeta', PACKAGE = 'OOPS', seq, beta)
}
...
probSeqGivenBetaLog <- function(seq, beta) {
    .Call('_OOPS_probSeqGivenBetaLog', PACKAGE = 'OOPS', seq, beta)
}
...
probSeqGivenPos <- function(seq, alpha, beta, pos) {
    .Call('_OOPS_probSeqGivenPos', PACKAGE = 'OOPS', seq, alpha, beta, pos)
}
...
probSeqGivenPosLog <- function(seq, alpha, beta, pos) {
    .Call('_OOPS_probSeqGivenPosLog', PACKAGE = 'OOPS', seq, alpha, beta, pos)
}
...
computeIC <- function(alpha, beta) {
    .Call('_OOPS_computeIC', PACKAGE = 'OOPS', alpha, beta)
}
...
computeICU <- function(alpha) {
    .Call('_OOPS_computeICU', PACKAGE = 'OOPS', alpha)
}
...
soft_update <- function(alpha, seq, posteriori) {
    invisible(.Call('_OOPS_soft_update', PACKAGE = 'OOPS', alpha, seq, posteriori))
}
...
hard_update <- function(alpha, seq, posteriori) {
    invisible(.Call('_OOPS_hard_update', PACKAGE = 'OOPS', alpha, seq, posteriori))
}
...
kmers2alpha <- function(kmers) {
    .Call('_OOPS_kmers2alpha', PACKAGE = 'OOPS', kmers)
}
...
alpha2kmers <- function(alpha, fasta) {
    .Call('_OOPS_alpha2kmers', PACKAGE = 'OOPS', alpha, fasta)
}
...
fasta2alpha <- function(fasta, k) {
    .Call('_OOPS_fasta2alpha', PACKAGE = 'OOPS', fasta, k)
}
...
corr <- function(a, b) {
    .Call('_OOPS_corr', PACKAGE = 'OOPS', a, b)
}
...
corr_freq <- function(correlation_str) {
    .Call('_OOPS_corr_freq', PACKAGE = 'OOPS', correlation_str)
}
...
fast_corr_freq <- function(a, b) {
    .Call('_OOPS_fast_corr_freq', PACKAGE = 'OOPS', a, b)
}
...
computeDKL <- function(alpha, beta, kmer) {
    .Call('_OOPS_computeDKL', PACKAGE = 'OOPS', alpha, beta, kmer)
}
...
computeDKLU <- function(alpha, kmer) {
    .Call('_OOPS_computeDKLU', PACKAGE = 'OOPS', alpha, kmer)
}
...
computeSCORE <- function(alpha) {
    .Call('_OOPS_computeSCORE', PACKAGE = 'OOPS', alpha)
}
